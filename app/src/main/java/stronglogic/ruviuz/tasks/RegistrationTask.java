 ...
 * Logs into Ruviuz
 */
public class RegistrationTask extends AsyncTask<String[], String, boolean[]> {

    private static final String TAG = "RuviuzREGISTRATIONTASK";

    private String email, password, authToken, baseUrl;

    private AsyncResponse delegate;

    public RegistrationTask(String email, String password, String baseUrl, AsyncResponse delegate) {
        this.email = email;
